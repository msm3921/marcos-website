...
?>
<!-- *****LEFT OFF TRYING TO FIX THE HAS 
POST THUMBNAIL.
When I replace the default image with a new one it fails
to grab the replacement
 -->
	<!-- feature image -->
<!-- 	<?php if ( has_post_thumbnail() ) {//check for feature image ?>
		<section class="feature-image" style="background: url('<?php echo $thumbnail_url; ?>') no-reapeat; background-size: cover;" data-type="background" data-speed="2">
